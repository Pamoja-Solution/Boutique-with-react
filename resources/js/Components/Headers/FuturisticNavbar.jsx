...
export default function FuturisticNavbar({ auth }) {
    ...
    <div className="hidden md:flex flex-col w-64 bg-base-200 shadow-lg border-r border-base-300">
        ...
        <nav className="flex-1 overflow-y-auto p-2">
            <ul className="menu menu-md p-0 gap-1">
                ...
                {/* NOUVEAU: Stocks */}
                <li>
                    <Link href={route('stocks.index')} className="flex items-center gap-3">
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                ...
                {/* NOUVEAU: Inventaires */}
                <li>
                    <Link href={route('inventories.index')} className="flex items-center gap-3">
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                ...
                <li>
                    <Link href={route('sales.index')} className="flex items-center gap-3">
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                ...
                {/* NOUVEAU: Clients */}
                <li>
                    <Link href={route('clients.index')} className="flex items-center gap-3">
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                ...
                {/* NOUVEAU: Caisse */}
                <li>
                    <Link href={route('cashregister.index')} className="flex items-center gap-3">
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
        ...
        <div className={`absolute left-0 top-0 h-full bg-base-200 shadow-xl transform ${
            ...
            <nav className="h-[calc(100%-180px)] overflow-y-auto p-2">
                <ul className="menu menu-md p-0 gap-1">
                    ...
                    <li>
                        <Link href={route('products.index')} className="flex items-center gap-3" onClick={() => setMobileMenuOpen(false)}>
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                                <path fillRule="evenodd" d="M10 2a4 4 0 00-4 4v1H5a1 1 0 00-.994.89l-1 9A1 1 0 004 18h12a1 1 0 00.994-1.11l-1-9A1 1 0 0015 7h-1V6a4 4 0 00-4-4zm2 5V6a2 2 0 10-4 0v1h4zm-6 3a1 1 0 112 0 1 1 0 01-2 0zm7-1a1 1 0 100 2 1 1 0 000-2z" clipRule="evenodd" />
                            </svg>
                            Produits
                    ...
                    {/* Stocks */}
                    <li>
                        <Link href={route('stocks.index')} className="flex items-center gap-3" onClick={() => setMobileMenuOpen(false)}>
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                                <path fillRule="evenodd" d="M5 5a3 3 0 015-2.236A3 3 0 0114.83 6H16a2 2 0 110 4h-5V9a1 1 0 10-2 0v1H4a2 2 0 110-4h1.17A3 3 0 015 5zm4.244 6.898l-1.5-1.5 4.243-4.242 1.5 1.5-4.243 4.242zM9.3 14.3a1 1 0 10-1.4 1.4l1.3 1.3a1 1 0 001.5 0l5.3-5.3a1 1 0 00-1.4-1.4l-5.3 5.3z" clipRule="evenodd" />
                            </svg>
                            Gestion des stocks
                    ...
                    {/* Inventaires */}
                    <li>
                        <Link href={route('inventories.index')} className="flex items-center gap-3" onClick={() => setMobileMenuOpen(false)}>
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                                <path d="M9 2a1 1 0 000 2h2a1 1 0 100-2H9z" />
                                <path fillRule="evenodd" d="M4 5a2 2 0 012-2 3 3 0 003 3h2a3 3 0 003-3 2 2 0 012 2v11a2 2 0 01-2 2H6a2 2 0 01-2-2V5zm3 4a1 1 0 000 2h.01a1 1 0 100-2H7zm3 0a1 1 0 000 2h3a1 1 0 100-2h-3zm-3 4a1 1 0 100 2h.01a1 1 0 100-2H7zm3 0a1 1 0 100 2h3a1 1 0 100-2h-3z" clipRule="evenodd" />
                            </svg>
                            ...
                            <ul tabIndex={0} className="menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow bg-base-100 rounded-box w-52">
                                <li className="menu-title pb-1">
                                    <div className="flex flex-col">
                                        ...
                                        <span className="text-xs opacity-70">Administrateur</span>
                                    </div>
                                </li>
                                <div className="divider my-1"></div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
                    ...
                    <div className="stats shadow bg-base-100">
                        <div className="stat">
                            ...
                            <div className="stat-value text-primary">145,290 XAF</div>
                    ...
                    <div className="stats shadow bg-base-100">
                        <div className="stat">
                            ...
                            <div className="stat-value text-success">43,580 XAF</div>
                            ...
                            <div className="space-y-3 max-h-64 overflow-y-auto">
                                <div className="flex gap-3 items-start">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-xs opacity-70">Il y a 10 min • 15,200 XAF</p>
                                    </div>
                                </div>
                                ...
                                <div className="flex gap-3 items-start">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-xs opacity-70">Il y a 2h • Loyer • 75,000 XAF</p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="card-body">
                            ...
                            <div className="space-y-2 max-h-40 overflow-y-auto">
                                <div className="flex justify-between items-center p-2 bg-info bg-opacity-10 rounded-lg">
                                    ...
                                    <span className="font-medium">245,300 XAF</span>
                                </div>
                                <div className="flex justify-between items-center p-2 bg-info bg-opacity-10 rounded-lg">
                                    <div>
